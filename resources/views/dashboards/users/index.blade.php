            ...
            <div class="row">
                ...
                <div class="card-container col-md-3 col-sm-6">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">امتحان {{ $subject->sub_name }}</h4>
                            <p class="card-text time">زمان امتحان: {{ $subject->timer }}</p>
                            <p class="card-text score">نمره امتحان: {{ $subject->total_score }}</p>
                            <a href="{{ route('exam_page', ['sub_classesses_id' => $subject->sub_classesses_id]) }}" class="btn btn-primary">شروع امتحان</a>
                        </div>
                    </div>
                </div>
                @endforeach
